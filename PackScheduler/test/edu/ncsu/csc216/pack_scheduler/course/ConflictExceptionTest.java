...
/**
 * ConflictExceptionTest class tests the custom exception ConflictException. Specifically, tests
 * that the ConflictException can be constructed with a custom provided message and a default message.
 * 
